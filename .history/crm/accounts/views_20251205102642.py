...
from .serializers import (UserSerializer,ProductSerializer,SlideShowSerializer,CartSerializer,
    ReceiptSerializer,
)
...
class SlideShowViewSet(viewsets.ModelViewSet):
    queryset = TblSlideShow.objects.all().order_by('ID')
    serializer_class = SlideShowSerializer


# -------------------- CART --------------------
class CartViewSet(viewsets.ModelViewSet):
    queryset = TblCarts.objects.all().order_by('userId')
