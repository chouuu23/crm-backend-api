...
class Location(models.Model):
    ...
    def __str__(self):
        return f"{self.user.name} - {self.detail_address}"
...
class Receipt(models.Model):
    ...
    ordered_from = models.CharField(max_length=255, default="Unknown Store")
    delivered_to = models.CharField(max_length=255, default="Unknown Address")
