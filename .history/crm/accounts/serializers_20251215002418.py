...
from .models import User,Products, Banner,Carts, Receipt, Order,Category,Location,Table,Reservation,BookingItem
...
class TableBookingSerializer(serializers.ModelSerializer):
    food_list = BookingItemSerializer(many=True, read_only=True)
