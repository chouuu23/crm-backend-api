...
class MyReceipt(models.Model):
    ...
    # Location label like "AUB, Phnom Penh"
    location = models.CharField(max_length=255)

    # Items format: 
    # [
    #   {"name": "Spaghetti", "price": 3.0},
    #   {"name": "Steak Meat", "price": 5.0}
    # ]
    items = models.JSONField()

    subtotal = models.DecimalField(max_digits=10, decimal_places=2)
    delivery_fee = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    vat_percent = models.DecimalField(max_digits=4, decimal_places=2, default=0)
    ...
    def __str__(self):
        return f"Receipt #{self.receiptId}"
