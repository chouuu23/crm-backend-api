...
class ReceiptViewSet(viewsets.ModelViewSet):
    """
    Full CRUD for Receipt with:
    - Filtering only receipts for logged-in user
    - Auto-set owner on create
    - mark_paid endpoint
    """
    queryset = Receipt.objects.all().select_related("user").prefetch_related("items").order_by('-created_at')
