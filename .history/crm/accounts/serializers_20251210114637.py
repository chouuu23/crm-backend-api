from rest_framework import serializers,Reservation
from django.contrib.auth.hashers import make_password,check_password
from .models import User,Products, SlideShow, Carts, MyReceipt, Order,Category,Location,Table
# Imports Users, Products, TblSlideShow, TblCarts, TblReceipt


from .models import MyReceipt,TableBooking


class MyReceiptSerializer(serializers.ModelSerializer):
    class Meta:
        model = MyReceipt
        fields = '__all__'
