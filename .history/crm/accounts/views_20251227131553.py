...
from .serializers import (
    PaymentSerializer, UserSerializer, LoginSerializer, RegisterSerializer,
...
#     # ).order_by("-created_at")
#     payments = Payment.objects.filter(
#     booking__customer_name=request.GET.get("name")
# )
...
#         .order_by("method", "-created_at")  # ✅ order by method
#     )
