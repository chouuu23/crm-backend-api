...
from .views import create_table_booking

from .views import (
    RegisterView, LoginView, UserViewSet, ProductViewSet,
    CartViewSet, ReceiptViewSet, OrderViewSet,
    CategoryViewSet, LocationViewSet, save_location,TableBookingViewSet,TableViewSet,ReservationViewSet,TableBookingCreateAPIView
)
...
urlpatterns = [
    ...
    path('banners/', BannerListAPIView.as_view(), name='banner-list'),
     path("bookings/", TableBookingCreateAPIView.as_view(), name="booking-create"),
]
