...
from .models import (Users,Products,SlideShow,Carts,Receipt,O)

from .serializers import (UserSerializer,ProductSerializer,SlideShowSerializer,CartSerializer,ReceiptSerializer,OrderSerializer)
