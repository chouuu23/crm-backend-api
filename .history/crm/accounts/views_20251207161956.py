...
from .models import (Login,Products,SlideShow,Carts,Receipt,Order,Category)

from .serializers import (LoginViewSet,ProductSerializer,SlideShowSerializer,CartSerializer,ReceiptSerializer,OrderSerializer,CategorySerializer)
