...
class TableBooking(models.Model):
    ...
    # ✅ NEW: food list (from Flutter)
    # Example:
    # [
    #   {"name": "Cake", "qty": 1, "price": 3.00},
    #   {"name": "Croissant", "qty": 2, "price": 2.50}
    # ]
    food_list = models.JSONField(default=list, blank=True)

    # ✅ NEW: total food price
...
class Reservation(models.Model):
    ...
    def __str__(self):
        return f"Reservation #{self.id} on {self.date} {self.time}"
