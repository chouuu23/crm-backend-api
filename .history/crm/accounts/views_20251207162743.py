...
from .models import (Users,Register,Products,SlideShow,Carts,Receipt,Order,Category)

from .serializers import (UserSerializer,RegisterSerializer,ProductSerializer,SlideShowSerializer,CartSerializer,ReceiptSerializer,OrderSerializer,CategorySerializer)
...
class RegisterView(viewsets.CreateAPIView):
