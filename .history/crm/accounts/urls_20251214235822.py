...
from .views import (
    ...
    CategoryViewSet, LocationViewSet, save_location,TableBookingViewSet,TableViewSet,ReservationViewSet,TableBookingListCreateAPIView
)
...
urlpatterns = [
    ...
    path("bookings/", TableBookingListCreateAPIView.as_view()),
]
