...
class Receipt(models.Model):
    ...
    # Delivery details
    ordered_from = models.CharField(max_length=255)      # Example: "Moji Food Shop"
    delivered_to = models.CharField(max_length=255)      # Example: "AUB, Phnom Penh"

    delivered_at = models.DateTimeField()                # Example: 2025-01-10 16:32
    ...
    payment_method = models.CharField(
        max_length=50,
        choices=[("Cash on Delivery", "Cash on Delivery"), ("Online Payment", "Online Payment")],
