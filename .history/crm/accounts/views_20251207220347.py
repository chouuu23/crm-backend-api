...
from rest_framework.views import APIView,re
...
from .serializers import (RegisterSerializer,ProductSerializer,SlideShowSerializer,CartSerializer,ReceiptSerializer,OrderSerializer,CategorySerializer)
