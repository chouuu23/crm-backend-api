...
from .models import User,Products, Banner,Carts, Receipt, Order,Category,Location,Table,Reservation,Payment
...
#     customer_name = serializers.CharField(source='booking.customer_name')
#     class Meta:
#         model = Payment
#         fields = [
#             "id",
...
class PaymentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            "id",
            "booking",             # write-only input
            "booking_id",          # read-only output
            "booking_customer",
            "amount",
            "method",
            "status",
