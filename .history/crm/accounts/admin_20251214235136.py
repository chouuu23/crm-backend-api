...
from .models import Banner, User, Category, Products, SlideShow, Carts, Receipt, Order,Location,TableBooking,Table
from .models import Table, Reservation

@admin.register(TableBooking)
class TableBookingAdmin(admin.ModelAdmin):
    list_display = ("date", "time", "guests", "customer_name", "total")
