...
from .serializers import (UserSerializer,LoginSerializer,RegisterSerializer,ProductSerializer,SlideShowSerializer,CartSerializer,ReceiptSerializer,OrderSerializer,CategorySerializer)
